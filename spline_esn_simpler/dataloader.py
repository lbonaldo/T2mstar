...
### val
x_val = torch.Tensor(np.load(os.path.join(c.data_path, 'x_eval.npy')))
y_val_e = torch.Tensor(np.load(os.path.join(c.data_path, 'y_sigma_eval.npy')))
y_val_s = torch.Tensor(np.load(os.path.join(c.data_path, 'y_seebeck_eval.npy')))
y_val_n = torch.Tensor(np.load(os.path.join(c.data_path, 'y_n_eval.npy')))
