...
scheduler_e = torch.optim.lr_scheduler.ReduceLROnPlateau(optim_e, mode='min', factor=0.1, patience=5, threshold=0.001, threshold_mode='rel', cooldown=0, min_lr=1e-06, eps=1e-08)
...
scheduler_s = torch.optim.lr_scheduler.ReduceLROnPlateau(optim_s, mode='min', factor=0.1, patience=5, threshold=0.001, threshold_mode='rel', cooldown=0, min_lr=1e-06, eps=1e-08)
...
scheduler_n = torch.optim.lr_scheduler.ReduceLROnPlateau(optim_n, mode='min', factor=0.1, patience=5, threshold=0.001, threshold_mode='rel', cooldown=0, min_lr=1e-06, eps=1e-08)
