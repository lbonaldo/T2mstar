...
scheduler_e = torch.optim.lr_scheduler.StepLR(optim_e, step_size=1, gamma=gamma)
...
scheduler_s = torch.optim.lr_scheduler.StepLR(optim_s, step_size=1, gamma=gamma)
...
scheduler_n = torch.optim.lr_scheduler.StepLR(optim_n, step_size=1, gamma=gamma)
