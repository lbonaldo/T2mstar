...
def run_train():
    ...
    try:
        ...
        for i_epoch in range(-c.pre_low_lr, c.n_epochs):
            ...
            val_losses  = train.train_epoch(i_epoch, test=True)

            val_loss_cum = sum(val_losses[0],val_losses[1],val_losses[2])
            ...
            monitoring.show_loss(np.concatenate([train_losses, val_losses]))
